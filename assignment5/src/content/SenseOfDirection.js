...
class SenseOfDirection extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        showMe: {
  ...
  render() {
    return (
        <div class = "grid-content"><article>
            ...
            That might seem like a lot, but after awhile, this all becomes second nature. Navigate. Use but don't rely on a map. Walk around a lot, but know where you are when you walk around. Form a mental map and make it better and better as you walk around.</p></li>
            </ol>
          ...
          <GridComments showMe = {this.state.showMe}/>
        </div>
    );
}
}
export default SenseOfDirection;